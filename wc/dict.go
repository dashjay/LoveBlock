...
const (
	...
	rHelpLove = "「表白模式」\n直接<a href='weixin://bizmsgmenu?msgmenuid=1&msgmenucontent=表白'>点我回复「表白」</a>\n即可预发送一条表白，接下来按照提示操作即可。\n\n" +
		"直接<a href='weixin://bizmsgmenu?msgmenuid=1&msgmenucontent=search ZFQ'>点我回复「搜索表白」</a>，按照消息触发即可搜索表白，快看看你是否已经被表白了吧？\n\n" +
		"直接<a href='weixin://bizmsgmenu?msgmenuid=1&msgmenucontent=random 5'>点我回复「随机查看」</a>，随机来几条"

	rReceiveLoveNormal = "「表白模式」\n小新已经收到了你充满爱意的表白啦，后台完毕之后将生成区块，并展示在本日文章中哦。也可以自行点击查看\n<a href='http://114.55.92.2:8002/'>点击查看本条表白</a>"
